...
void tui_sbar(bool force_update)
{
	...
	gfx_printf("%K%k 电池: %d.%d%% (%d mV) - 充电:", 0xFF303030, 0xFF888888,
...
void *tui_do_menu(menu_t *menu)
{
	...
	while (true)
	{
		...
		if (h_cfg.emummc_force_disable)
			gfx_printf("%k未找到emuMMC配置。\n", 0xFF800000);
		gfx_con_setpos(0,  1191);
		gfx_printf("%k 音量键: 上下移动\n 电源键: 选择选项%k", 0xFF555555, 0xFFCCCCCC);
